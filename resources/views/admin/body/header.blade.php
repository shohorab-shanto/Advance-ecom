    ...
    <nav class="navbar navbar-static-top pl-30">
      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
          ...
          {{-- to connect this form with admin table --}}
          @php
          ...
          <li class="dropdown user user-menu">
			<a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
				<img src="{{ (!empty($adminData->profile_photo_path)) ? url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/avatar-1.png') }}" alt="">
			</a>
			<ul class="dropdown-menu animated flipInX">
			  <li class="user-body">
				 <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="ti-user text-muted mr-2"></i> Profile</a>
                 <a class="dropdown-item" href="{{ route('all.user') }}"><i class="ti-user text-muted mr-2"></i> All User</a>
