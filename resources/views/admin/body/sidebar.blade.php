    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ ($prefix == 'order')? 'active':'' }} ">
            ...
            <ul class="treeview-menu">
              <li class="{{ ($route == 'pending')? 'active':'' }}"><a href="{{ route('pending') }}"><i class="ti-more"></i>Pending Orders</a></li>
              <li class="{{ ($route == 'confirm')? 'active':'' }}"><a href="{{ route('confirm') }}"><i class="ti-more"></i>Confirm Orders</a></li>
              <li class="{{ ($route == 'processing')? 'active':'' }}"><a href="{{ route('processing') }}"><i class="ti-more"></i>Processing Orders</a></li>
              <li class="{{ ($route == 'picked')? 'active':'' }}"><a href="{{ route('picked') }}"><i class="ti-more"></i>Picked Orders</a></li>
              <li class="{{ ($route == 'shipped')? 'active':'' }}"><a href="{{ route('shipped') }}"><i class="ti-more"></i>Shipped Orders</a></li>
              <li class="{{ ($route == 'delivered')? 'active':'' }}"><a href="{{ route('delivered') }}"><i class="ti-more"></i>Delivered Orders</a></li>
              <li class="{{ ($route == 'cancel')? 'active':'' }}"><a href="{{ route('cancel') }}"><i class="ti-more"></i>Cancel Orders</a></li>
            </ul>
          </li>
